...
// Seed data for initial Junoud setup
...
export const seedProducts = [
  {
    ...
    description: 'This is a sample product for your Junoud store.',
...
export const seedGlobals = {
  ...
  footer: {
    ...
    copyright: '© 2024 Junoud. All rights reserved.',
  },
  settings: {
    siteName: 'Junoud',
